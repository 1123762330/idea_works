...
public class RouteServlet extends BaseServlet {
    ...
    //收藏榜单
    public void fcList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("fcList启动了...");
        //2.调用service查询
        List<Route> list = favoriteService.FavoriteList();
        //3.序列化json返回
        writeValue(list,response);
        System.out.println("----查询到的Route集合对象为:"+list);
        System.out.println("fcList结束了!!!");
    }

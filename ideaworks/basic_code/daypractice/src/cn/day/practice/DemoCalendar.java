...
public class DemoCalendar {
    public static void main(String args[]) {
        ...
        CalendarFrames frame = new CalendarFrames();
    ...
    static class CalendarFrames extends JFrame implements ActionListener {
        ...
        int year = 2018, month = 9; //启动程序显示的日期信息
        CalendarDemo1 calendar;
        JLabel showMessage = new JLabel("", JLabel.CENTER);
        JLabel lbl1 = new JLabel("请输入年份：");
        JLabel lbl2 = new JLabel("      ");

        public CalendarFrames() {
